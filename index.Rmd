...
runningheader: "Eine Bearbeitung im literal-programming-Stil in R Markdown" # only for pdf output
subtitle: "Eine Bearbeitung im literal-programming-Stil in R Markdown" # only for html output
